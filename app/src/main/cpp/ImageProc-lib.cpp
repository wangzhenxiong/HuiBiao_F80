...
extern "C" void Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_pixeltobmp(JNIEnv *env, jobject thiz,
                                                              jobject bitmap) {
...
extern "C" jint Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_prepareCamera(JNIEnv *env, jobject thiz, jint videoid) {
...
extern "C" jint Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_prepareCameraWithBase(JNIEnv *env, jobject thiz,
                                                                         jint videoid,
                                                                         jint videobase) {
    ...
    return Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_prepareCamera(env, thiz, videoid);

}

extern "C" void Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_processCamera(JNIEnv *env,jobject thiz) {

    readframeonce();
}

extern "C" void Java_com_wangzx_dy_sample_mvp_widget_CameraPreview_stopCamera(JNIEnv *env, jobject thiz) {
