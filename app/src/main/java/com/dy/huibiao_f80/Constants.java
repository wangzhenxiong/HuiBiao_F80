...
public class Constants {
     ...
     **/
    public static final byte[]  COLLAURUM_ENT_SCANNING_REQUEST_P = new byte[]{0x7E, 0x11, 0x01, 0x00, 0x01, (byte) FindCRC(new byte[]{0x11, 0x01, 0x00, 0x01}), 0x7E}
    , COLLAURUM_OUT_REQUEST_P = new byte[]{0x7E, 0x11, 0x01, 0x00, 0x02, (byte) FindCRC(new byte[]{0x11, 0x01, 0x00, 0x02}), 0x7E}
    , COLLAURUM_ENT_REQUEST_P = new byte[]{0x7E, 0x11, 0x01, 0x00, 0x03, (byte) FindCRC(new byte[]{0x11, 0x01, 0x00, 0x03}), 0x7E}
    , COLLAURUM_DATA_REQUEST_P = new byte[]{0x7E, 0x15, 0x00, 0x00, (byte) 0xcb, 0x7E}
    , COLLAURUM_NUMBER_ASK_P = new byte[]{0x7e, 0x1b, 0x00, 0x00, (byte) FindCRC(new byte[]{0x1b, 0x00, 0x00}), 0x7e}
    ;
