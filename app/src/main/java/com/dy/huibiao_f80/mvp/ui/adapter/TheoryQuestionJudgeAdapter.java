 ...
 * Description:
 */
public class TheoryQuestionJudgeAdapter extends BaseQuickAdapter<BeginTheoryExam_Back.EntityBean.TheoryQuestionJudgeListBean, BaseViewHolder> {
    public TheoryQuestionJudgeAdapter(int layoutResId, @Nullable List<BeginTheoryExam_Back.EntityBean.TheoryQuestionJudgeListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, BeginTheoryExam_Back.EntityBean.TheoryQuestionJudgeListBean item) {
