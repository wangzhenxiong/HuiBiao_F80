 ...
 * Description:
 */
public class MySpinnerAdapterFGGD extends BaseAdapter implements SpinnerAdapter {
    List<ProjectFGGD>messageList;
    Context mContext;
    public MySpinnerAdapterFGGD(List<ProjectFGGD>list, Context context) {
        messageList=list;
        mContext=context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProjectFGGD item = (ProjectFGGD) getItem(position);
