 ...
 * Description:
 */
public class MySpinnerAdapterJTJ extends BaseAdapter implements SpinnerAdapter {
    List<ProjectJTJ>messageList;
    Context mContext;
    public MySpinnerAdapterJTJ(List<ProjectJTJ>list, Context context) {
        messageList=list;
        mContext=context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProjectJTJ item = (ProjectJTJ) getItem(position);
