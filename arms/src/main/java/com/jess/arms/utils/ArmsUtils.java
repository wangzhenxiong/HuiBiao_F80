...
public class ArmsUtils {
     ...
     * @param string
     */
    public static void makeDialog(Context context, String string) {
        AlertDialog.Builder mAlertDialog = new AlertDialog.Builder(context);
        mAlertDialog.setTitle("提示");
        mAlertDialog.setMessage(string);
     ...
     * @param text
     */
    public static void dialogText(String text) {

        AppManager.getAppManager().showDialog(text);
    }
